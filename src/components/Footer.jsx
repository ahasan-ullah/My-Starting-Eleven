    ...
    <div className='bg-[#06091A] p-5 md:p-10'>
      ...
      <footer className="footer">
        <nav>
          ...
          <div className="text-[#FFFFFF99] text-justify">My Starting Eleven offers a dynamic fantasy sports <br/>platform where fans can create teams, compete, <br/>and earn rewards based on real player performances.
          </div>
        </nav>
        <nav>
        ...
        <form>
          ...
          <fieldset className="form-control w-full">
            <label className="label">
              <span className="label-text text-[#FFFFFF99]">Subscribe to our newsletter for the latest updates.</span>
            </label>
            <div className="join">
              <input
                type="text"
              ...
              />
              <button onClick={(event)=>event.preventDefault()} className="btn join-item bg-gradient-to-r from-indigo-300 via-orange-300 to-pink-300">Subscribe</button>
            </div>
          </fieldset>
        </form>
      </footer>
